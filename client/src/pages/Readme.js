            ...
            <>
                ...
                <Container>
                    <article className="markdown-body entry-content p-5" itemProp="text">
                        ...
                        <p>Home page <code>/home</code>:</p>
                        <ul>
                            <li>Welcome home page.</li>
                            <li>You can scroll and see pictures with effect, and get information about the restaurant.</li>
                            <li>Each of the pages in the app is accompanied by a navbar that lets you navigate between the different app pages. The
                                navbar also contains a cart button which is used as a pop-up on mouseover, Above it is a number showing the quantity
                        ...
                        <ul>
                            ...
                            <li>Products for a signed-in user will be stored in a database so that a user can see them even after the site is
                                refreshed or exited.
                            </li>
                        ...
                        <ul>
                            ...
                            <li>Integrate with Node Express and save the data (And deployment to Heroku that I wanted to do to allow my site to be
                                public).
                            </li>
